...
public class AppSQL extends SQLiteOpenHelper {
    final String AdminstratorTable = "CREATE TABLE adminstrator_tb(id int primary key autoincrement, avatar int NOT NULL, money_reciever int NOT NULL)";
...
//    final String CategoryTable = "create table category_tb(id int primary key autoincrement, fullname text NOT NULL, max_people int NOT NULL, beds int NOT NULL, bedrooms int NOT NULL, service_fee money NOT NULL)";
    final String RoomTable = "create table room_tb(id int primary key autoincrement,fullname text NOT NULL, brand_name text NOT NULL, category_name text NOT NULL, rate int NOT NULL, max_people int NOT NULL, beds int NOT NULL, rooms int NOT NULL, note text, size text NOT NULL, service text NOT NULL, cost int NOT NULL, status int NOT NULL)";

    // cái category tôi chưa hiểu gồm những gì đâu, có gì check nhé
    // thiếu gì thêm sao

    //Update 8:30 18/11/2022 - Lai : Update SQL nhé
