...
//    final String RoomImageTable = "create table roomImage_tb(id integer primary key autoincrement,room_id integer references room_tb(id) NOT NULL,image BLOB NOT NULL)";
//, collaborate_id integer references user_tb(id) NOT NULL
