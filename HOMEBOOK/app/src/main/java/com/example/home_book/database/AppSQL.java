...
public class AppSQL extends SQLiteOpenHelper {
    ...
    final String RatingTable = "create table rating_tb(id integer primary key autoincrement, user_id integer references user_tb(id) NOT NULL, order_id integer references order_tb(id) NOT NULL, rating integer NOT NULL,note text NOT NULL)";
